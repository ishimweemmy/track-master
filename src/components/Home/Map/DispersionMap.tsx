    ...
    <div className="w-full h-fit">
      ...
      >
        ...
        {selectedLocation && (
          ...
          >
            <div className="w-[12rem] h-[9rem] flex flex-col rounded-3xl p-6 justify-center items-center gap-3 text-white backdrop-blur-lg text-xl font-bold bg-[#000000b5]">
