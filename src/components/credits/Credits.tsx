  ...
  return (
    <div className="w-[80%] h-fit flex flex-col items-center gap-8 px-4">
      ...
      <div className="w-full h-full flex gap-4">
        <div className="w-[75%] h-full flex flex-col items-center justify-center gap-6 lTable:w-full">
        ...
        <div className="w-[30%] h-full rounded-xl flex flex-col items-start justify-center gap-8 p-6 bg-gray lTable:hidden">
          <span className="text-3xl font-bold text-white tracking-wider">
            Deposit
          </span>
